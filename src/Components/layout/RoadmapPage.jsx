        ...
        <div className="relative flex items-center mb-6 min-h-[40px]">
            ...
            <div className={`absolute left-0 transition-all duration-500 ease-in-out ${selectedPhaseId ? 'opacity-100 z-10 pointer-events-auto' : 'opacity-0 -z-10 pointer-events-none'}`}>
                <button 
                    ...
                    className="p-2 rounded-full bg-white border border-slate-200 text-slate-600 hover:bg-slate-100 transition-colors duration-300 shadow-sm flex items-center justify-center"
